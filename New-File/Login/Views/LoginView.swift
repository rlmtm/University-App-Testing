                ...
                VStack {
                    HStack{
                     ...
                     HStack{
                         ...
                         TextField("Password", text: $loginVM.credentials.pass) {
                             UIApplication.shared.endEditing1()
                         }
                         .padding(.leading, 12).font(.system(size: 20))
                     ...
                     HStack{
                         ...
                         TextField("Re-Password", text: $loginVM.credentials.repass){
                             UIApplication.shared.endEditing1()
                         }
                         .padding(.leading, 12).font(.system(size: 20))
                 ...
                 Button(action: {
                     if loginVM.SignUpDisabled == false {
                         if loginVM.credentials.pass == loginVM.credentials.repass {
                             ...
                             self.loginVM.credentials.pass = self.loginVM.credentials.repass
                     ...
                     print(loginVM.credentials.pass)
                     print(loginVM.credentials.user)
                 }) {
