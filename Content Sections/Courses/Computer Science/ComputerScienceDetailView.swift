...
/////////////////                                                       First Box
    ...
    var FirstBox: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("20 sections - 3 hours".uppercased())
                ...
                //})
            Text("Learn the process of getting a major in computer science and more ...")
                .font(.footnote)
                //.if(!isLiteMode, transform: { view in
    ...
    var SecondBox: some View {
        VStack(alignment: .leading, spacing: 12) {
            ZStack {
                ListItem1
                NavigationLink(destination: ComputerScienceIdealApplicant()) {
                    Rectangle()
            ...
            ZStack {
                ListItem2
                NavigationLink(destination: ComputerScienceExtraCurricular()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem3
                NavigationLink(destination: ComputerScienceCourseStructure()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem4
                NavigationLink(destination: ComputerScienceCourseRequirements()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem5
                Link(destination: URL(string: "https://www.topuniversities.com/university-rankings/university-subject-rankings/2021/computer-science-information-systems")!) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
...
struct ComputerScienceDetailView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ComputerScienceDetailView(/*namespace: namespace, showComputerScience: .constant(true)*/)
    }
}
