...
/////////////////                                                       First Box
    ...
    var FirstBox: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("20 sections - 3 hours".uppercased())
                ...
                //})
            Text("Learn the process of getting a major in law studies and more ...")
                .font(.footnote)
                //.if(!isLiteMode, transform: { view in
    ...
    var SecondBox: some View {
        VStack(alignment: .leading, spacing: 12) {
            ZStack {
                ListItem1
                NavigationLink(destination: LawIdealApplicant()) {
                    Rectangle()
            ...
            ZStack {
                ListItem2
                NavigationLink(destination: LawExtraCurricular()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem3
                NavigationLink(destination: LawCourseStructure()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem4
                NavigationLink(destination: LawCourseRequirements()) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
            ...
            ZStack {
                ListItem5
                Link(destination: URL(string: "https://www.topuniversities.com/university-rankings/university-subject-rankings/2021/law-legal-studies")!) {
                    Rectangle()
                        .frame(width: 240, height: 60, alignment: .leading)
                        .opacity(0)
                        .padding(.leading, 70)
...
struct LawDetailView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        LawDetailView(/*namespace: namespace, showLaw: .constant(true)*/)
    }
}
